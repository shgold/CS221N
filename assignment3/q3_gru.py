...
class SequencePredictor(Model):
    ...
    def add_training_op(self, loss):
        ...
        grads = [x[0] for x in compute_grad]
        variables = [x[1] for x in compute_grad]
        ...
        train_op = optimizer.apply_gradients(zip(grads, variables), name = 'train_op')
