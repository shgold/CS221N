...
class GRUCell(tf.contrib.rnn.RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            ## It seems like which one we define first is important.
            ## The result is different when define U,W,b first and then calculate z,r,h for each time.
            ...
            o_t = tf.tanh(tf.matmul(inputs, U_o) + r_t* tf.matmul(state, W_o) + b_o, name = 'o_t')
